 ...
 *
 * Requires GMAIL_EMAIL + GMAIL_APP_PASSWORD env vars. Generate an App
 * Password at https://myaccount.google.com/apppasswords (needs 2FA enabled
 * on the Google account first).
 */
async function checkUtrViaImap(utr, { limit = 100 } = {}) {
